...
export const commands = {
    'play-animation-on': async (elementId, animationName, duration, iterations, animationId, pid, resolver) => {
    ...
    // scenes animation
    'fadeIn': async (value, pid, resolver) => {
